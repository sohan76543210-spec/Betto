...
GitHub Actions থেকে প্রতিদিন চলে। football_api.py + predictor.py (bot.py-এর মূল লজিক,
অপরিবর্তিত) ব্যবহার করে আজ/আগামীকালের ম্যাচের প্রেডিকশন বানিয়ে ../data/predictions.json
ফাইলে লেখে। এই JSON ফাইলটাই Mini App (index.html) fetch করে দেখায় -
তাই API key কখনো ব্রাউজারে যায় না, শুধু GitHub Actions-এর ভেতরে থাকে।
"""
