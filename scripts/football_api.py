...
# (World Cup ২০২৬ ইতিমধ্যে শেষ ১৯ জুলাই; Euro এই বছর হচ্ছেই না; Champions League
# শুধু কোয়ালিফায়ার রাউন্ডে আছে, মূল গ্রুপ স্টেজ সেপ্টেম্বরে শুরু) — সেগুলো fdo-এর
# আউটপুট থেকে বাদ দেওয়া হয় যাতে এদের জন্য পরের ধাপে অযথা API কল না যায়।
# ⚠️ কোডগুলো (WC, EC, CL) football-data.org-এর স্ট্যান্ডার্ড কম্পিটিশন কোড ধরে
# নেওয়া হয়েছে — football_data_org.py দেখে নিশ্চিত করে নেওয়া ভালো এগুলোই ব্যবহার
# হচ্ছে কিনা।
EXCLUDED_FDO_CODES = {"WC", "EC", "CL"}
