...
def predict_match(home_team_id, away_team_id, max_goals=7, deep=None, match_id=None, match_date=None):
    ...
    form_h = recency_weighted_scored_conceded(home_recent, home_team_id, half_life=RECENCY_HALF_LIFE)
    form_a = recency_weighted_scored_conceded(away_recent, away_team_id, half_life=RECENCY_HALF_LIFE)
