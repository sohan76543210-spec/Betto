...
TOP_PICKS_COUNT = 10
MIN_QUOTA_BUFFER = 10
# Final publication gate: weak probability/reliability combinations are not published.
# This keeps the daily output selective instead of forcing a pick for every finalist.
MIN_FINAL_PROB = 0.55
...
def build():
    ...
    for _,m,base_pred in finalists:
        ...
        # Final publication gate: require both probability and reliability,
        # while retaining the minimum fair-odds constraint.
        if best is None:
